...
function traceUserData(message, metadata) {
    ...
    winston.log(LogLevel.Info, message, Object.assign({}, metadata, { telemetry: true }));
}
...
function traceErrorOrWarning(level, message, error, metadata) {
    ...
    winston.log(level, message, Object.assign({}, metadata, { message: error.message, errorLine: firstLine, telemetry: true }));
}
